...
public class PDFExporter  {
    ...
    public void exportUserProfileAndActivitiesToPDF(UserProfile userProfile, List<UserActivity> activities) {
        Document document = new Document();

        try {
            PdfWriter.getInstance(document, new FileOutputStream(userProfile.getUserName() + "_profile.pdf"));
            document.open();
